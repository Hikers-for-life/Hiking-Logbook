...
jest.mock('../components/hero-section', () => ({
  HeroSection: () => (
    <section>
      Hero
      <section data-testid="hero-hooks" />{' '}
    </section>
  ),
}));
jest.mock('../components/logbook-section', () => ({
  LogbookSection: () => <section>Logbook Section</section>,
}));
...
describe('Page smoke tests', () => {
  ...
  test('Achievements renders heading and create goal button', async () => {
    ...
    expect(
      await screen.findByText(/Achievements & Progress/i)
    ).toBeInTheDocument();
