import { formatTimeAgo, formatAbsoluteTime, formatTime } from '../utils/timeUtils';
...
describe('timeUtils', () => {
  ...
  describe('formatTimeAgo', () => {
    ...
    test('should format hours correctly', () => {
      ...
      const twentyThreeHoursAgo = new Date(MOCK_NOW.getTime() - 23 * 60 * 60 * 1000);
    ...
    test('should format weeks correctly', () => {
      ...
      const twoWeeksAgo = new Date(MOCK_NOW.getTime() - 14 * 24 * 60 * 60 * 1000);
      expect(formatTimeAgo(twoWeeksAgo)).toBe('2 weeks ago');
      
      const fourWeeksAgo = new Date(MOCK_NOW.getTime() - 28 * 24 * 60 * 60 * 1000);
    ...
    test('should accept ISO string timestamps', () => {
      const isoString = new Date(MOCK_NOW.getTime() - 2 * 60 * 60 * 1000).toISOString();
